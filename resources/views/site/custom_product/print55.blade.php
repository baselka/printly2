        ...
        <form >
           ...
           <input type="hidden" value="0" id="uploaded" name="uploaded" />
            ...
            <div class="step-1">
                ...
                <div class="pink-layout">
                    ...
                    <div class="upload-layout mb-4">
                        <div class="cell">
                            ...
                            <input class="input-b1" id="input-b1"  type="file" multiple data-browse-on-zone-click="true">
                        </div>
                ...
                <div class="empty-file-layout blue-layout text-center ">
                    <img src="./img/icons/empty-folder.png ">
                    <h3 class="light mt-4 ">لا توجد ملفات مرفوعة </h3>
                </div> --}}
            ...
            <h3>
                ...
                <div class="blue-layout ">
                    ...
                    <div class="radio-container style-3">
                        ...
                        <div class="pretty p-icon p-toggle p-smooth p-plain ">
                            ...
                            <div class="state ">
                                <p class="icon">
                                    <img src="{{'/uploads/cover_type/'.$type->photo}}">
                                    <span>{{$type->name}}</span>
                                </p>
                                <label></label>
                            </div>
