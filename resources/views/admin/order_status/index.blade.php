            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrum-right">
                        <div class="dropdown">
                            <a class="btn btn-success" href="{{route('add-order-status')}}">{{__('public.add')}}</a>
                        </div>
                    </div>
                </div>
            </div>
					 ...
					 <th scope="col">{{__('public.delete')}}</th>
                        ...
                        @foreach($order_status as $status)
                            <tr>
                                ...
                                <td><a href="{{route('edit-order-status', ['id' =>$status->id ])}}">{{__("public.edit")}}</a></td>
                                <td><a href="{{route('delete-order-status', ['id' =>$status->id ])}}">{{__("public.delete")}}</a></td>
