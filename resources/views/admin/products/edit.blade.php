                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('update-product' , ['id'=>$product->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="short_desc" type="text" class="form-control @error('short_desc') is-invalid @enderror" name="short_desc" value="{{ $product->short_desc }}" required autocomplete="short_desc" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="drive_url" type="text"
                                    ...
                                    value="{{ $product->drive_url }}" required autocomplete="drive_url" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cost_price" type="text"
                                    ...
                                    value="{{ $product->cost_price }}" required autocomplete="cost_price" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="publisher_price" type="text"
                                    ...
                                    name="publisher_price" value="{{ $product->publisher_price }}" required
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="author" type="text" class="form-control @error('author') is-invalid @enderror"
                                    name="author" value="{{ $product->author }}" required autocomplete="author" autofocus>
                            ...
                            <div class="col-md-6 ">
                                <table class="table">
                                    ...
                                    <tbody class="images_box">
                                        @foreach (explode(",",$product->multi_images) as $img)

                                        <tr id="image-row{{$image_row}}"> <td><input id="photo" onchange="readURL(this,{{$image_row}}')" type="file" class="form-control " name="imgs[]"  autocomplete="off" autofocus>
                                            <img id="imgPreview{{$image_row}}" src="{{URL::to('/uploads/products/'.$img)}}" alt="your image" />
                                        </td>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <table class="table table-borderd">
                                    ...
                                    <tbody class="covers">
                                        @foreach ($cover_prop as $coverprop)
                                        <tr id="cover-row{{$image_row2}}"> <td>  <select class="select2 form-control" name="covers[]"  >
                                        <optgroup label="{{ __('public.covers') }}">
                                        @foreach ($covers as $cover)'+
                                            <option value="{{ $cover->id }}" @if($cover->id == $coverprop->prop_id) selected @endif>{{ $cover->name }}</option>
                                            @endforeach
                                          </optgroup>
                                         </select>
                                        </td>
                                        <td>            <input type="number" name="cover_price[]" value="{{$coverprop->price}}" placeholder="السعر الأضافي" class="form-control" /></td>

                                        <td><button type="button" onclick="removed_cover( {{$image_row2}} )" data-toggle="tooltip" title="" class="btn btn-primary"><i class="fa fa-minus-circle"></i></button></td>
                                        </tr>
                                        <?php
                                          $image_row2 ++;
                                        ?>
                        ...
                        <div class="form-group row">
                           ...
                           @foreach ($printer_prop as $cprop)
                           <tr id="printer-row{{$image_row3}}"> <td>  <select class="select2 form-control" name="printer_color[]"  >
                           <optgroup label="{{ __('public.covers') }}">
                           @foreach ($printer_color as $printer)'+
                               <option value="{{ $printer->id }}" @if($printer->id == $cprop->prop_id) selected @endif>{{ $printer->name }}</option>
                               @endforeach
                             </optgroup>
                            </select>
                           </td>
                           <td>            <input type="number" name="printer_color_price[]" value="{{$cprop->price}}" placeholder="السعر الأضافي" class="form-control" /></td>

                           <td><button type="button" onclick="removed_printer( {{$image_row3}} )" data-toggle="tooltip" title="" class="btn btn-primary"><i class="fa fa-minus-circle"></i></button></td>
                           </tr>
                           <?php
                                          $image_row3 ++;
                                        ?>
        ...
        function addPrinterColor() {
            ...
            $('.printer_color').append('<tr id="printer-row' + image_row3 +
               ...
               ' @foreach ($printer_color as $printer)'+
                ...
                '<td><button type="button" onclick="removed_printer(' + image_row3 +
                ')" data-toggle="tooltip" title="" class="btn btn-primary"><i class="fa fa-minus-circle"></i></button></td>' +
                '</tr>');
