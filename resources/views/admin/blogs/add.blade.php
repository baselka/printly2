                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="{{route('add-blog')}}">{{ __('public.add') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('add-blog')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="desc" type="text" class="form-control @error('desc') is-invalid @enderror" name="desc" required autocomplete="price" autofocus></textarea>
                        ...
                        <div class="form-group row">
                            <label for="accepted" class="col-md-4 col-form-label text-md-right">{{__('public.approved_state')}} </label>
