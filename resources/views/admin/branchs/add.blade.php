            ...
            <div class="card-content">
                <div class="card-body">
                    <form method="POST" action="{{ route('add-branch')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">تفاصيل الفرع</label>
                        ...
                        <div class="form-group row">
                            <label for="google_map" class="col-md-4 col-form-label text-md-right">رابط خرائط جوجل</label>

                            <div class="col-md-6">
                                <input id="google_map" type="text" class="form-control @error('google_map') is-invalid @enderror" name="google_map" value="{{ old('google_map') }}" required autocomplete="google_map" autofocus>
