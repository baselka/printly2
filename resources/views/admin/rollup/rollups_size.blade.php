            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0"> احجام الرول اب </h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/">{{__('public.home')}}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{route('rollups-size')}}">احجام الرول اب </a>
                                    </li>
            ...
            <div class="card-content">
                ...
                <div class="card-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                          @if($rollups_size)
                        @foreach($rollups_size as $size)
                            <tr>
                                <th scope="row">{{$size->id}}</th>
                                <td>{{$size->name}}</td>

                                <td><a href="{{route('edit-rollup-size', ['id' =>$size->id ])}}">{{__("public.edit")}}</a></td>
