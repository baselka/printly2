                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('add-area')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="precent" type="text" class="form-control @error('precent') is-invalid @enderror" name="precent" value="{{ old('precent') }}" required autocomplete="precent" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="country" class="col-md-4 col-form-label text-md-right">{{ __('public.country') }}</label>
