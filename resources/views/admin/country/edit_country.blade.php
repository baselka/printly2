...
@section('content')
    ...
    'error'
            ...
            <div class="card-content">
                <div class="card-body">
                    <form method="POST" action="{{ route('update-country' , ['id'=>$country->id])}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="type" class="form-control" id="">
                                    <option value="1" @if($country->type == 1) selected @endif>مدينة</option>
                                    <option value="2" @if($country->type == 2) selected @endif> جامعة</option>
