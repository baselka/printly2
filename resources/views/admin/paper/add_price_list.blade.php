...
@section('content')
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="{{route('add-price-list' , ['id'=>$id])}}">{{ __('public.add') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    'error'
            ...
            <div class="card-content">
                <div class="card-body">
                    <form method="POST" action="{{ route('add-price-list' , ['id'=>$id])}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price_extra" type="text" class="form-control @error('price_extra') is-invalid @enderror" name="price_extra" value="{{ old('price_extra') }}" required autocomplete="price_extra" autofocus>
