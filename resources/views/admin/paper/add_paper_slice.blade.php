...
@section('content')
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="{{route('add-paper-slice')}}">{{ __('public.add') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    'error'
            ...
            <div class="card-content">
                <div class="card-body">
                    <form method="POST" action="{{ route('add-paper-slice')}}" enctype="multipart/form-data">
                        @csrf
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="paper_count" type="text" class="form-control @error('paper_count') is-invalid @enderror" name="paper_count" value="{{ old('paper_count') }}" required autocomplete="paper_count" autofocus>
