...
@section('content')
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="{{route('add-paper')}}">{{ __('public.add') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    'error'
            ...
            <div class="card-content">
                <div class="card-body">
                    <form method="POST" action="{{ route('add-paper')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="select2 form-control" name="type[]" multiple="multiple" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="select2 form-control" name="printer_type[]" multiple="multiple" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="select2 form-control" name="printer_color[]" multiple="multiple" >
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="select2 form-control" name="printer_method[]" multiple="multiple" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="select2 form-control" name="papers_slice[]" multiple="multiple" >
                          ...
                          <div class="form-group row">
                            <label for="papers_slice" class="col-md-4 col-form-label text-md-right">{{ __('public.covers') }}</label>


                            <div class="col-md-6">

                                <select class="select2 form-control" name="covers[]" multiple="multiple" >
