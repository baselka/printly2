            ...
            <div class="content-header row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('stickers-paper-type')}}">انواع الورق</a>
                                    </li>
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrum-right">
                        <div class="dropdown">
                            <a class="btn btn-success" href="{{route('add-stickers-paper-type')}}">{{__('public.add')}}</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($paper_types as $paper)
                            <tr>
                                ...
                                <td><a href="{{route('edit-stickers-paper-type', ['id' =>$paper->id ])}}">{{__("public.edit")}}</a></td>
