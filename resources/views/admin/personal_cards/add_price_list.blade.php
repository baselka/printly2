...
@section('content')
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('personal_cards-price-list')}}">{{__('public.price_list')}}</a>
                                    </li>
                                    <li class="breadcrumb-item active"><a href="{{route('add-personal_cards-price-list')}}">{{ __('public.add') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    'error'
            ...
            <div class="card-content">
                <div class="card-body">
                    <form method="POST" action="{{ route('add-personal_cards-price-list')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="select2 form-control" name="card_size"  >
                                    <optgroup label="{{__('public.papers_size')}}">


                                    @foreach($cards_size as $size )
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="select2 form-control" name="card_type"  >
