...
@section('content')
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="{{route('add-banner')}}">{{ __('public.add') }}</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    'error'
            ...
            <div class="card-content">
                <div class="card-body">
                    <form method="POST" action="{{ route('update-banner' , ['id'=>$banner->id])}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$banner->name}}"required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="link" type="text" class="form-control @error('link') is-invalid @enderror" name="link" value="{{$banner->link}}" required autocomplete="link" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               <input type="hidden" name="old_image" value="{{$banner->photo}}" />
                                @error('photo')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
