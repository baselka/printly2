...
(function(factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function() {
           ...
           tActionDownload = '<a class="kv-file-download {downloadClass} show_splite_file" title="تقسيم" ' +
                'href="javascript:void(0)" >{downloadIcon}</a>';
            ...
            tTagBef1 = tTagBef + '><div class="kv-file-content">\n  <div class="pretty p-default p-smooth p-round"><input type="checkbox" /><div class="state p-warning"><label class="small"> </label></div></div>';
            tTagBef2 = tTagBef + ' title="{caption}"><div class="pretty p-default p-smooth p-round"><input type="checkbox"  class="file_key" /><div class="state p-warning"><label class="small"> </label></div></div><div class="kv-file-content">\n';
            tTagAft = '</div>{footer}\n{zoomCache}</div>\n';
            tGeneric = '{content}\n';
            tStyle = ' {style}';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    downloadIcon: '<img src="./img/icons/file-sm.png ">',
                    downloadClass: defBtnCss1,
                    downloadTitle: 'Download file',
                    zoomIcon: '<img src="./img/icons/preview-sm.png ">',
        ...
        _setZoomContent: function($frame, navigate) {
            var self = this,
                ...
                parsed, zoomData = $frame.data('zoom');
            if (zoomData) {
